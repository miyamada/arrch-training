      ...
      {showForm && (
        <div style={{
          ...
          <form onSubmit={handleSubmit}>
            ...
            {error && (
              <div style={{
                padding: '10px 14px', background: 'rgba(224,84,84,0.07)',
                border: '1px solid rgba(224,84,84,0.3)', borderRadius: '4px',
                color: '#e05454', fontSize: '13px', marginBottom: '16px',
              }}>{error}</div>
            )}
            ...
            <div style={{ display: 'flex', gap: '12px' }}>
              ...
              <button
                ...
                style={{
                  ...
                  color: '#6b7280', border: '1px solid #e5e7eb', borderRadius: '4px',
